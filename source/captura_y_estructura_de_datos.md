...
**Punto de Control** es una clase especializada de *LA_Punto* que representa puntos de la densificación de la red local, que se utiliza en la operación catastral para el levantamiento de información física de los objetos territoriales.
