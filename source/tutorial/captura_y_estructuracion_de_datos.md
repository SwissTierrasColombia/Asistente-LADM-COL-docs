...
Como se puede observar en la siguiente figura se solicita información del terreno por lo tanto se debe dar clic al al boton seleccionar objetos por area. ![Botón Selección](../_static/tutorial/captura_y_estructura_de_datos/ICOSeleccion.png)
...
<div class="note">
<p class="admonition-title">IMPORTANTE</p>
<p>Es necesario desarrollar este proceso para los terrenos que aparecen de color <b>rojo</b> en la siguiente imágen.</p>
</div>
