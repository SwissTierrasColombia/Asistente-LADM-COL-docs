...
Esta funcionalidad cuenta con un wizard desarrollado para guiar al usuario dependiendo del sistema de información catastral de origen de los datos. Estos corresponden a SNC (Sistema Nacional Catastral) o COBOL (**CO**mmon **B**usiness-**O**riented **L**anguage)
